...
urlpatterns = [
    ...
    path('sales/lead/create/', views.sales_lead_create, name='sales_lead_create'),
    path('sales/lead/<int:pk>/', views.sales_lead_detail, name='sales_lead_detail'),
    path('sales/lead/<int:pk>/edit/', views.sales_lead_edit, name='sales_lead_edit'),
    path('sales/lead/<int:pk>/delete/', views.sales_lead_delete, name='sales_lead_delete'),
    path('sales/lead/bulk-action/', views.sales_lead_bulk_action, name='sales_lead_bulk_action'),
    path('sales/sources/', views.sales_source_list, name='sales_source_list'),
    path('sales/source/create/', views.sales_source_create, name='sales_source_create'),
    path('sales/source/<int:pk>/edit/', views.sales_source_edit, name='sales_source_edit'),
    path('sales/source/<int:pk>/delete/', views.sales_source_delete, name='sales_source_delete'),
    path('sales/report/', views.sales_report, name='sales_report'),
    path('sales/export-csv/', views.sales_export_csv, name='sales_export_csv'),
    path('sales/quick-add-lead/', views.sales_quick_add_lead, name='sales_quick_add_lead'),
